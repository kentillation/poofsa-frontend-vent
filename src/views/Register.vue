            ...
            <v-card class="pa-3 login-card">
                <v-row>
                    <v-col cols="12" lg="6" md="6" sm="12" class="pa-8">
                        <div @click="this.$router.push('/')" class="text-info" style="cursor: pointer;">
                        ...
                        <p class="text-center mt-5">To continue, kindly fill-out the given fields below.</p>
                        <v-form ref="form" @submit.prevent="handleRegister" v-model="isFormValid" class="pa-5">
                            <div class="text-subtitle-1 text-medium-emphasis">Mobile number</div>
                            <v-text-field v-model="phone_number" :rules="[requiredRule]"
                            ...
                            <v-btn :disabled="!isFormValid || loading" color="#0090b6" type="submit" size="large"
                                class="mt-3" height="45" block rounded>
                                Register
                            </v-btn>
                        </v-form>
                    </v-col>
